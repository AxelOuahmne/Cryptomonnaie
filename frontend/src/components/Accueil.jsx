...
import graph from '../asset/img/graphe.png'
function Accueil() {
                                ...
                                <div className="carousel-item" data-bs-interval="2000">
                                    ...
                                    <div className="box-caruse">
                                        ...
                                        <div className="numbers text-number">
                                            <p className='text-danger'><i class="fa-solid fa-arrow-down"></i> 00.67%</p>
                                            <p className='text-success'><i class="fa-solid fa-arrow-up"></i> 85.99%</p>
                                            <p className='text-danger'><i class="fa-solid fa-arrow-down"></i> 20.75%</p>
                                        </div>
                                    </div>
                                    {/* <div className="carousel-caption">
                                        <h2>hooo</h2>
